...
<div class="container">
    ...
    @else
        ...
        <div class="col-md-4 mb-4">
                    <div class="card bg-dark text-light border-0 shadow-lg" style="border-radius: 10px;">
                        ...
                        <div class="card-body">
                            <!-- Nome do Produto -->
                            <h5 class="card-title text-success" style="font-size: 1.2rem; height: 50px; overflow: hidden;">
                                <a href="{{ route('product.show', $produto->id) }}" class="text-decoration-none text-light">
    ...
    <a href="{{ route('catalogo') }}" class="btn btn-outline-success mt-3">Voltar ao Catálogo</a>
</div>
@endsection